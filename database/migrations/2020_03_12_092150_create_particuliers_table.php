...
class CreateParticuliersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('particuliers', function (Blueprint $table) {
            ...
            $table->boolean('echangeActif')->default(0);
            ...
            $table->boolean('echange_definitif')->default(0);
            $table->boolean('echange_provisoir')->default(0);

            $table->dateTime('echange_periode_un')->nullable();
            $table->dateTime('echange_periode_deux')->nullable();
