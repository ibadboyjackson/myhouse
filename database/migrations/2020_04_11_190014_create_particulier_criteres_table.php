...
class CreateParticulierCriteresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('particulier_criteres', function (Blueprint $table) {
            $table->id();
            ...
            $table->bigInteger('particulier_id')->references('id')->on('particuliers')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('particulier_criteres');
    }
}
