    ...
    let calendar = $('#calendar').fullCalendar({
        ...
        select: function(start, end, allDay) {
            ...
            $("#btn-time").click(function() {
                ...
                $.ajax({
                    ...
                    url: SITEURL + "/api/calendar/pro/add",
                    data: 'professionnel_id=' + $professionnel + '&amp;start=' + $start + '&amp;end=' + end + '&amp;user_id=' + $user,
                    type: "POST",
        ...
        eventDrop: function(event, delta) {
            ...
            $("#btn-time").click(function() {
                ...
                $.ajax({
                    url: SITEURL + '/api/calendar/pro/update',
        ...
        eventClick: function(event) {
            ...
            if (deleteMsg) {
                ...
                $.ajax({
                    ...
                    url: SITEURL + '/api/calendar/pro/delete',
