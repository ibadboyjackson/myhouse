...
class Professionnel extends Model
{
    ...
    public function setEchangePeriodeUnAttribute ($input) {
        $this->attributes['echange_periode_un'] =
    ...
    public function critere () {
        return $this->hasMany(ProfessionnelCritere::class);
    }

    public function favorite_to_user () {
        return $this->belongsToMany(User::class, 'professionnel_interesses')->withTimestamps();
    }
}
