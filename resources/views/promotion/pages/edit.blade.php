...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Modifier ce code promotion</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('promotion.update', $promotion->id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="price" type="text" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ $promotion->price }}"  autocomplete="price" autofocus placeholder="Entrer un chiffre entre 1 et 100">
