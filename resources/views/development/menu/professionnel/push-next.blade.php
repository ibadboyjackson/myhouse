            ...
            <div class="menu-body">
                ...
                <div class="menu-body-contents">
                    <div class="menu-body-content-campaign">
                        <div class="menu-body-content-campaign-left">Sélectionnez unE CAMPAGNE PUBLICITAIRE</div>
                        <div class="menu-body-content-campaign-right">Planifier vos campagnes Facebook 24 heures à l'avance </div>
                    </div>
                    <div class="menu-body-content-campaign-select">
                        <div class="form-group">
                            ...
                            <select name="#" id="#" class="form-control css-select">
                                <option value="">Push mobile</option>
                                <option value="">Push mobile</option>
                                <option value="">Push mobile</option>
                                <option value="">Push mobile</option>
                            </select>
                    ...
                    <div class="menu-body-content-campaign-s-title">Votre notification est prête</div>
                    ...
                    <div class="menu-body-content-campaign-push-next">
                        <div class="menu-body-content-campaign-push-next-item">
                            <div class="menu-body-content-campaign-push-next-item-block">
                                ...
                                <div class="menu-body-content-campaign-push-next-item-block-item pb-site">
                                    ...
                                    <div class="menu-body-content-campaign-push-next-item-block-item-title">Agence du VAL DE MARNE</div>
                                    <div class="menu-body-content-campaign-push-next-item-block-item-content mb-content">Bouskoura Casablanca</div>

                                    <div class="menu-body-content-campaign-push-next-item-block-item-content mb-content">Le meilleur de l'immobilier</div>
                                    ...
                                    <div class="menu-body-content-campaign-push-next-item-block-item-content mb-content">
                                        Venez nombreux et profitez des meilleures offres.
                                        Visitez les plus belles villas de la région.
                                        En front de mer, ou au cœur d'une verdure flamboyante, c'est vous qui décidez !
                                    </div>

                                    <div class="menu-body-content-campaign-push-next-item-block-item-content">
                                        Spa- Terrains de sport- Vues imprenables <br>
                                        Golf - Mosquée - Espaces verts - Solarium
                        ...
                        <div class="menu-body-content-campaign-push-next-item">
                            <div class="menu-body-content-campaign-push-next-item-ck">
                               <div class="menu-body-content-campaign-push-next-item-ck-title">Programmer le Push</div>
