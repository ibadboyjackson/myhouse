            ...
            <div class="menu-body">
                ...
                <div class="menu-body-contents">
                    <div class="menu-body-content-campaign">
                        ...
                        <div class="menu-body-content-campaign-right">Planifier vos campagnes Facebook 48 heures à l'avance </div>
                    </div>
                    <div class="menu-body-content-campaign-select">
                        <div class="form-group">
                            ...
                            <select name="#" id="#" class="form-control css-select">
                                <option value="">Bannière 970x250px page d'accueil</option>
                                <option value="">Bannière 970x250px page d'accueil</option>
                                <option value="">Bannière 970x250px page d'accueil</option>
                                <option value="">Bannière 970x250px page d'accueil</option>
                            </select>
                    ...
                    <div class="menu-body-content-campaign-boxes">
                        <div class="menu-body-content-campaign-boxes-item-one">
                            <div class="menu-body-content-campaign-boxes-item-one-title">Télécharger la bannière</div>
                            <div class="upload-img text-center">
                                <label for="file-upload" class="custom-file-upload">
                                    <img src="http://myhouse.com/images/residential/upload.svg" alt="">
                                </label>
                                <input id="file-upload" type="file">
                                <div class="upload-text">ENVOYER bannière</div>
                            </div>
                        </div>
                        <div class="menu-body-content-campaign-boxes-item-two">
                            <div class="menu-body-content-campaign-boxes-item-one-title">Activer la période</div>
                    ...
                    <a href="{{ route('professionnel.menu.campaign.success') }}" style="text-decoration: none; color: inherit">
