                    ...
                    <div class="display-item">
                        <div class="page-list-panelle">
                            <div class="page-list-panel-item">
                                ...
                                <a href="http://myhouse.com/resultat/professionnels/residence-alpe" style="text-decoration: none; color: inherit" target="_blank">

                                </a>
                                <div class="carousel slide" data-ride="carousel" id="slider1"><a href="http://myhouse.com/resultat/professionnels/residence-alpe" style="text-decoration: none; color: inherit" target="_blank">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img class="img-fluid" src="http://myhouse.com/images/residential/mix.png" alt="First Slide">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="img-fluid" src="http://myhouse.com/images/residential/mix.png" alt="Second Slide">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="img-fluid" src="http://myhouse.com/images/residential/mix.png" alt="Third Slide">
                                            </div>
                                        </div>
                                    </a><a class="carousel-control-prev" href="#slider1" role="button" data-slide="prev">
