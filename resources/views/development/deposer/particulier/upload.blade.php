        ...
        <div class="ca-page">
                    ...
                    <div class="ca-page-item-second-round">
                        ...
                        <div class="ca-page-item-second-round-block">
                            ...
                            <div class="ca-page-item-second-round-block-rounded">
                                ...
                                <div class="ca-page-item-second-round-block-rounded-text ca-page-txt-active ">Médias & Texte</div>
                            </div>
                        </div>
                    </div>

                    <div class="ca-page-item-third-connexion">
                        <form action="{{ route('particulier.success') }}" method="get">
                            @csrf
                                ...
                                <div class="ca-page-item-third-type-boxe">
                                   ...
                                   <div class="ca-page-item-third-type-boxe-upload-results">
                                    ...
                                    <div class="ca-page-item-third-type-boxe-upload-description">
                                        <textarea name="#" id="#" cols="30" rows="10" class="form-control" placeholder="Quelque chose à rajouter ? Tapez votre texte ici"></textarea>
                                    </div>
                                </div>
            ...
            <div class="ca-page-item">
                ...
                <div class="ca-page-item-thirds">
                    ...
                    <div class="ca-page-item-third-text pt-3 text-center">
                        Parlez-nous plus de votre bien
                    </div>
                </div>
            </div>
        </div>
