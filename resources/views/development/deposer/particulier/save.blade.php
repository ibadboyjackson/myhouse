...
@if (request()->get('type') === 'appartement' || 'villa' || 'chalet' || 'riad' || 'ferme' || 'chambre')
                            ...
                            <div class="ca-page-item-second-round">
                                ...
                                <div class="ca-page-item-second-round-block">
                                    <div class="ca-page-item-second-round-block-rounded">
                                        ...
                                        <div class="ca-page-item-second-round-block-rounded-text ca-page-txt-active text-uppercase">Connecté(e)</div>
                                    </div>
                                    <div class="ca-page-item-second-round-block-rounded">
                                        <div class="ca-page-item-second-round-block-rounded-circle ca-page-bg-active">2</div>
                                        <div class="ca-page-item-second-round-block-rounded-text ca-page-txt-active text-uppercase">catégories & caractéristiques</div>
                                        <div class="ca-page-item-second-round-block-rounded-dots">
                                            <div class="ca-page-item-second-round-block-rounded-dot dot-active"></div>
                                            <div class="ca-page-item-second-round-block-rounded-dot dot-active"></div>
                                            <div class="ca-page-item-second-round-block-rounded-dot"></div>
                                        </div>
                                    </div>
                                    <div class="ca-page-item-second-round-block-rounded text-uppercase">
                                        <div class="ca-page-item-second-round-block-rounded-circle">3</div>
                                        <div class="ca-page-item-second-round-block-rounded-text">Localisez <br> le bien</div>
                                    </div>
                                    <div class="ca-page-item-second-round-block-rounded text-uppercase">
                                        <div class="ca-page-item-second-round-block-rounded-circle">4</div>
                                        <div class="ca-page-item-second-round-block-rounded-text">Téléchargez les médias & publiez</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <!-- Must change -->
                                    ...
                                    <div class="ca-page-item-third-types-box-four">
                                        ...
                                        <div class="ca-page-item-third-type-box">
                                            <div class="ca-page-item-third-type-box-item">
                                            ...
                                            <div class="ca-page-item-third-type-box-item">
                                                ...
                                                <div class="pc-y">
                                                    <div class="pc_yt">
                                                        <div class="pc_ytt">
                                                            <input type="radio" id="sort30" name="type" value="commerce">
                                                            <label for="sort30">Commerce</label>
                                                        </div>
                                                    </div>
                                                    <div class="pc_yt">
                                                        <div class="pc_ytt">
                                                    ...
                                                    <div class="pc_yt">
                                                        <div class="pc_ytt">
                                                            <input type="radio" id="sort17" name="type" value="entrepôt">
                                                    ...
                                                    <div class="pc_yt">
                                                        <div class="pc_ytt">
                                                            <input type="radio" id="sort20" name="type" value="propriéte_agricole">
                    ...
                    <div class="ca-page-item">
                        <div class="ca-page-item-third">
                            ...
                            <div class="ca-page-item-third-text pt-3 text-center">
                                Décrivez {{ request()->get('type') }} et <br>
...
@elseif (request()->get('type') === "cite" || 'bureau' || "plateau")
...
@elseif (request()->get('type') === 'agricole' || 'residentiel' || 'industriel' || 'commercial' || 'propriéte_agricole')
...
@elseif (request()->get('type') === 'immeuble' || 'garage' || 'local_industriel' || 'local_commercial')
...
@else
    <h2>Ce choix ne correspond pas recommencez</h2>
@endif
