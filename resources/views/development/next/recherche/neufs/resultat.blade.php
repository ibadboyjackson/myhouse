                ...
                <div class="the-page-enterprise-logo-box">
                    ...
                    <div class="the-page-enterprise-logo-box-content">
                        ...
                        <div class="the-page-enterprise-logo-box-content-button">
                            <a href="{{ route('neuf.entreprise') }}" style="text-decoration: none; color: inherit">
            ...
            <div class="the-page-type">
                ...
                <div class="the-page-type-box">
                    ...
                    <div class="the-page-type-name bg-g-light">
                        ...
                        <div class="the-page-type-name-room">De 2 à 4 chambres</div>
                        <div class="the-page-type-name-room">De 120m2 à 360m2</div>
                    </div>
                ...
                <div class="the-page-type-box">
                    ...
                    <div class="the-page-type-name bg-r-light">
                        <div class="the-page-type-name-title">Appartement</div>
                        <div class="the-page-type-name-room">De 2 à 4 chambres</div>
                        <div class="the-page-type-name-room">De 120m2 à 360m2</div>
                    </div>
                ...
                <div class="the-page-grid-container">
                    ...
                    <div class="the-page-grid-container-item">
                        ...
                        <div class="the-page-suggestion">
                            ...
                            <div class="the-page-suggestion-type-button">
                                <a href="{{ route('appartement') }}" style="text-decoration: none; color: inherit">
                                    Appartements
                                </a>
                            </div>
                            ...
                            <div class="the-page-suggestion-type-button" style="margin-top: -20px !important;">
                                <a href="{{ route('villa') }}" style="text-decoration: none; color: inherit">
                                    Villas
                                </a>
                            </div>
                            <div class="the-page-suggestion-media">
                            ...
                            <div class="the-page-suggestion-type-button" style="margin-top: -20px !important;">
                                <a href="{{ route('commerce') }}" style="text-decoration: none; color: inherit">
                                    Commerces
                                </a>
                            </div>
                            <div class="the-page-suggestion-media">
                            ...
                            <div class="the-page-suggestion-type-button" style="margin-top: -20px !important;">
                                <a href="{{ route('terrain') }}" style="text-decoration: none; color: inherit">
                                    Terrains
                                </a>
                            </div>
                            <div class="the-page-suggestion-media">
                    ...
                    <div class="the-page-grid-container-item">
                        <div class="carte-infos text-center mt-106">
