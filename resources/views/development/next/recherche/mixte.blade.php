    ...
    <div class="row mt-25">
        <div class="mixte">
            <div class="row just-row">
                <div class="col-md-6 order-2 order-md-1 just-row-md d-sm-none d-md-block pr-0">
                    <div class="is-map">
                        <div class="map" id="map"></div>
                    </div>
                </div>
                <div class="col-md-6 order-1 order-md-2 just-row-md col-sm-12" style="overflow-y: auto">
                    <div class="is-list ml-2">

                        <div class="button-sp" id="button-sp">
                            <i class="fas fa-caret-right button-sp-d"></i>
                        </div>
                        <div class="row pb-67">
                            <div class="col-md-6">
