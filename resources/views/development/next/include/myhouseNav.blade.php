<nav class="myhouseNav">
    <div class="myhouseNav-nav">
        <div class="navbar-logo">
            <a href="/" class="nav-logo">
                <img src="{{ asset('development/images/logo.svg') }}" alt="" class="img-fluid" width="66" height="66">
            </a>
        </div>
        ...
        <div class="navbar-right" id="with-menu">
            <div class="content-nav">
                ...
                <div class="content-nav-five">
                    <button class="btn align-self-center rounded-pill myHouse-red btn-second" id="appstore">Apps MyHouse</button>
                    <div id="appstore-dropdown" class="content-nav-five-dropdowm">
                        ...
                        <div class="content-nav-five-dropdowm-box">
                            ...
                            <div class="content-nav-five-dropdowm-box-img">
                                <img src="{{ asset('images/residential/single/menu/windows.png ') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
