    ...
    <div class="container-fluid fluid">
        ...
        <div class="collapse navbar-collapse"  id="navbarNav">
            ...
            <div class="mr-auto ml-5 d-flex">
                <div class="nav-item mr-50 lang" id="lang">
                    ...
                    <div class="d-block mr-1 im-1-1">
                        ...
                        <span class="country-dropdown" id="country-dropdown">
                ...
                <div class="nav-item mr-50">
                    ...
                    <div class="d-block im-2" id="currency">
                        <img src="{{ asset('images/residential/currency.svg') }}" alt=""><br>
                        <span class="t-b-1">€</span>
                        <span class="currency-dropdown" id="currency-dropdown">
                ...
                <div class="nav-item mr-50">
                    <div class="d-block"></div>
                    <div class="d-block im-2" id="surface-dropdown">
                        <img src="{{ asset('images/residential/measure.svg') }}" alt=""><br>
                        <span class="t-b-2">m²</span>
                        <span class="surface-dropdown" id="surface">
            ...
            <div class="d-flex flex-row-reverse navbar-nav ml-auto">
                <a class="menu mt-2 nav-item" href="{{ route('annonce') }}">
                ...
                <div class="connection nav-item">
                    <a href="{{ route('connexion') }}">
                        <img src="{{ asset('images/residential/path.svg') }}" alt="">
                        <span class="text-connection">Se connecter</span>
                    </a>
                </div>

                <div class="button mr-7 d-flex nav-item">
                    <button class="btn btn-light align-self-center mr-54 text-center rounded-pill myHouse-red btn-blog">
                        <a href="{{ route('blog') }}" style="text-decoration: none; color: #46AB8E">
                            Blog
                        </a>
                    </button>
                    <button class="btn btn-light align-self-center mr-54 text-center rounded-pill myHouse-red btn-first">
                        <a href="{{ route('tarifs') }}" style="text-decoration: none; color: #46AB8E">
                            Déposer une annonce
                        </a>
                    </button>
