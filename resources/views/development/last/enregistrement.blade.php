    ...
    <div class="ca-page">
        ...
        <div class="ca-page-item">
            <div class="ca-page-item-second">
                ...
                <form action="{{ route('last.description') }}" method="get">
                    <div class="ca-page-item-third-connexion">
                        <div class="ca-page-item-third-connexion-box">
                            ...
                            <div class="ca-page-item-third-connexion-box-title-title">PROJET 2 & ENTREPRISE</div>
                    ...
                    <div class="ca-page-item-second-subscription">
                        <div class="ca-page-item-second-body">
                            ...
                            <div class="cap-page-item-second-body-child">
                                <div class="field">
                            ...
                            <div class="ca-page-item-second-enterprise-or" style="padding-top: 101px; padding-bottom: 104px;">ou</div>
