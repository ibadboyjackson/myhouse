...
@section('content')
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('promoter.register') }}</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('promoter.register') }}">
                            ...
                            <div class="form-group row">
                                <label for="nom" class="col-md-4 col-form-label text-md-right">{{ __('promoter.name') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="type_entreprise" class="col-md-4 col-form-label text-md-right">{{ __('promoter.type') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="siege_social" class="col-md-4 col-form-label text-md-right">{{ __('promoter.social') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('promoter.email') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="telephone" class="col-md-4 col-form-label text-md-right">{{ __('promoter.phone') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="site_web" class="col-md-4 col-form-label text-md-right">{{ __('promoter.website') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="address_postal" class="col-md-4 col-form-label text-md-right">{{ __('promoter.postal_address') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="nom_dirigent" class="col-md-4 col-form-label text-md-right">{{ __('promoter.lead_name') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="fonction_dirigent" class="col-md-4 col-form-label text-md-right">{{ __('promoter.lead_function') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="affiliation_web" class="col-md-4 col-form-label text-md-right">{{ __('promoter.affiliate_habit') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="habit_affiliation" class="col-md-4 col-form-label text-md-right">{{ __('promoter.adds_habit') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('promoter.password') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('promoter.confirm') }}</label>
