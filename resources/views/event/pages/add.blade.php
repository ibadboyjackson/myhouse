                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('event.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="prix" type="text" class="form-control @error('prix') is-invalid @enderror" name="prix" value="{{ old('prix') }}"  autocomplete="prix">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="dateDebut" type="datetime-local" class="form-control @error('dateDebut') is-invalid @enderror" name="dateDebut" value="{{ old('dateDebut') }}"  autocomplete="dateDebut">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="dateFin" type="datetime-local" class="form-control @error('dateFin') is-invalid @enderror" name="dateFin" value="{{ old('dateFin') }}"  autocomplete="dateFin">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="description" type="datetime-local" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description') }}"  autocomplete="description"></textarea>
