<div class="calendars">
    <div class="calendar-title text-center">{{ __('myhouse/calendrier.aa') }}</div>
    ...
    <!-- <div class="calendar-month-year text-center">
        <div class="row justify-content-center">
            <div class="calendar-prev" aria-label="prev">
                <img src="http://myhouse.com/images/residential/menu/list/prev.svg" alt="" class="img-fluid">
            </div>
            <div class="calendar-text text-capitalize">{{ __('myhouse/calendrier.ab') }}</div>
            <div class="calendar-next fc-next-button" aria-label="next">
    ...
    <!-- <div class="calendar-days d-flex justify-content-around">
        <div class="sunday">{{ __('myhouse/calendrier.ac') }}</div>
        <div class="monday">{{ __('myhouse/calendrier.ad') }}</div>
        <div class="tuesday">{{ __('myhouse/calendrier.ae') }}</div>
        <div class="wednesday">{{ __('myhouse/calendrier.af') }}</div>
        <div class="thursday">{{ __('myhouse/calendrier.ag') }}</div>
        <div class="friday">{{ __('myhouse/calendrier.ah') }}</div>
        <div class="saturday">{{ __('myhouse/calendrier.ai') }}</div>
    </div>
