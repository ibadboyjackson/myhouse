...
@section('title')
    {{ __('myhouse/back/menu/neuf/interesse.aa') }}
@stop
...
@section('content')
    <div class="menu-wrap">
        ...
        <!-- List -->
            ...
            <div class="the-pp pg-monster">
                <div class="menu-body pl-var">
                    <div class="menu-body-title">{{ __('myhouse/back/menu/neuf/interesse.ab') }}</div>
                    <div class="menu-body-hr"></div>
                    @if ($user === 'neuf')
                        <div class="menu-body-subs">
                            <span class="menu-body-subs-one">{{ __('myhouse/back/menu/neuf/interesse.ac') }}</span>
