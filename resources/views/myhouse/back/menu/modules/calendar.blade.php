<div class="menu-body-calendar">
    <div class="calendar">
        <div class="calendar-title text-center">{{ __('myhouse/back/menu/module/calendrier.aa') }}</div>
        ...
        <div class="calendar-month-year text-center">
            <div class="row justify-content-center">
                ...
                <div class="calendar-text text-capitalize">{{ __('myhouse/back/menu/module/calendrier.ab') }}</div>
        ...
        <div class="calendar-days d-flex justify-content-around">
            <div class="sunday">{{ __('myhouse/back/menu/module/calendrier.ac') }}</div>
            <div class="monday">{{ __('myhouse/back/menu/module/calendrier.ad') }}</div>
            <div class="tuesday">{{ __('myhouse/back/menu/module/calendrier.ae') }}</div>
            <div class="wednesday">{{ __('myhouse/back/menu/module/calendrier.af') }}</div>
            <div class="thursday">{{ __('myhouse/back/menu/module/calendrier.ag') }}</div>
            <div class="friday">{{ __('myhouse/back/menu/module/calendrier.ah') }}</div>
            <div class="saturday">{{ __('myhouse/back/menu/module/calendrier.ai') }}</div>
        </div>
