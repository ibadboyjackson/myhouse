...
@section('title')
    {{ __('myhouse/back/menu/professionnel/campaign/campaign.aa') }}
@stop
        ...
        <div class="menu-wrap">
            ...
            <!-- List -->
                ...
                <div class="menu-body">
                    ...
                    <div class="menu-body-title">{{ __('myhouse/back/menu/professionnel/campaign/campaign.ab') }}</div>
                    <div class="menu-body-hm">
                        <div class="menu-body-hr"></div>
                        <div class="menu-body-subs">
                            <span class="menu-body-subs-one">{{ __('myhouse/back/menu/professionnel/campaign/campaign.ac') }}</span>
                            <span class="menu-body-subs-two">{{ auth()->user()->email }}</span>
                        </div>
                    </div>
                    <form action="{{ route('professionnel.menu.campaign') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="menu-body-contents">
                            <div class="menu-body-content-campaign">
                                <div class="menu-body-content-campaign-left">{{ __('myhouse/back/menu/professionnel/campaign/campaign.ad') }}</div>
                                <div class="menu-body-content-campaign-right">{{ __('myhouse/back/menu/professionnel/campaign/campaign.ae') }}</div>
                            </div>
                            <div class="menu-body-content-campaign-select">
                                <div class="form-group">
                                    ...
                                    <select id="#" name="banniere_type" class="form-control css-select">
                                        <option value="600">{{ __('myhouse/back/modules/professionnel/subscription.aaa') }}</option>
                                        <option value="3001">{{ __('myhouse/back/modules/professionnel/subscription.aab') }}</option>
                                        <option value="3002">{{ __('myhouse/back/modules/professionnel/subscription.aac') }}</option>

                                    </select>
                                </div>
                            </div>
                            <div class="menu-body-content-campaign-boxes">
                                <div class="menu-body-content-campaign-boxes-item-one">
                                    <div class="menu-body-content-campaign-boxes-item-one-title">{{ __('myhouse/back/menu/professionnel/campaign/campaign.ag') }}</div>
                                    <div class="upload-img text-center">
                                        <label for="file" class="custom-file-upload">
                                            <img src="http://myhouse.com/images/residential/upload.svg" alt="">
                                        </label>
                                        <input id="file" type="file" name="image">
                                        <div class="upload-text">{{ __('myhouse/back/menu/professionnel/campaign/campaign.ah') }}</div>
                                    </div>
                                </div>
                                <div class="menu-body-content-campaign-boxes-item-two">
                                    <div class="menu-body-content-campaign-boxes-item-one-title">{{ __('myhouse/back/menu/professionnel/campaign/campaign.ai') }}</div>
                                    <div class="portail-content-map">
                                        <div class="portail-content-map-first">{{ __('myhouse/back/menu/professionnel/campaign/campaign.aj') }}</div>
                                        <div class="portail-content-map-second">
                                            <div class="portail-content-map-second-box">
                                                <div class="portail-content-map-second-box-item">
                                                    <label for="#"></label>
                                                    <input type="checkbox" name="dated" id="#" class="ios" value="1">
                                                </div>
                                                <div class="portail-content-map-second-box-item">
                                                    <input type="text" name="date" id="#" class="form-control protail-input" placeholder="jj/mm/aaaa">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="menu-body-content-campaign-boxes-button" style="background-color: transparent">
                                <button class="btn  btn-connections" type="submit">
                                    {{ __('myhouse/back/menu/professionnel/campaign/campaign.ak') }}
