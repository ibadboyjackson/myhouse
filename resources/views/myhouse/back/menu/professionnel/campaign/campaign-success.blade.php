...
@section('title')
    {{ __('myhouse/back/menu/professionnel/campaign/campaign-success.aa') }}
@stop
    ...
    <div class="professionnel">
        <div class="menu-wrap">
            ...
            <!-- List -->
                ...
                <div class="menu-body">
                    <div class="menu-body-title">{{ __('myhouse/back/menu/professionnel/campaign/campaign-success.ab') }}</div>
                    <div class="menu-body-hm">
                        <div class="menu-body-hr"></div>
                        <div class="menu-body-subs">
                            <span class="menu-body-subs-one">{{ __('myhouse/back/menu/professionnel/campaign/campaign-success.ac') }}</span>
                    ...
                    <div class="menu-body-contents">
                        <div class="menu-body-content-campaign">
                            <div class="menu-body-content-campaign-left">{{ __('myhouse/back/menu/professionnel/campaign/campaign-success.ad') }}</div>
                            <div class="menu-body-content-campaign-right">{{ __('myhouse/back/menu/professionnel/campaign/campaign-success.ae') }}</div>
                        </div>
                        <div class="menu-body-content-campaign-select">
                            <div class="form-group">
                                ...
                                <select name="#" id="#" class="form-control css-select">
                                    <option value="">{{ __('myhouse/back/menu/professionnel/campaign/campaign-success.af') }}</option>
                                    <option value="">{{ __('myhouse/back/menu/professionnel/campaign/campaign-success.af') }}</option>
                                    <option value="">{{ __('myhouse/back/menu/professionnel/campaign/campaign-success.af') }}</option>
                                    <option value="">{{ __('myhouse/back/menu/professionnel/campaign/campaign-success.af') }}</option>
                                </select>
                        ...
                        <div class="menu-body-content-campaign-select-boot">
                            {{ __('myhouse/back/menu/professionnel/campaign/campaign-success.ag') }}
                        </div>
                        <div class="menu-body-content-campaign-boxes-success">
                            <div class="menu-body-content-campaign-boxes-success-title">{{ __('myhouse/back/menu/professionnel/campaign/campaign-success.ah') }} <br>
                                {{ __('myhouse/back/menu/professionnel/campaign/campaign-success.ai') }}
                            </div>
                        ...
                        <a href="{{ route('professionnel.menu.backoffice') }}" style="text-decoration: none; color: inherit">
                            <div class="menu-body-content-campaign-boxes-button">
                                {{ __('myhouse/back/menu/professionnel/campaign/campaign-success.aj') }}
                            </div>
                        </a>
                    </div>
                </div>
