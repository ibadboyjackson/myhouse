...
<div class="ca-page-item-second-body-card-item-body ca-page-sp-mt">
                                                                    ...
                                                                    @if (request()->get('mvoie') == 1 && $particulier->voie != '00m')


                                                                        @if(isset($particulier->voie))
                                                                                    ...
                                                                                    <div class="box-displays">
                                                                                        <div>
                                                                                            <div class="pc-checkbox">
                                                                                                <input type="checkbox"  class = "myhouse-check" {{ old('voie') != null ? 'checked' : '' }} name="voie" id="voie" value="1" {{ isset($particulier->critere->last()->voie) && $particulier->critere->last()->voie == 1 ? 'checked' : '' }}>
                                                                                                <label for="voie">
                                                                                                </label>
                                                                                            </div>
                                                                                        </div>
                                                                    ...
                                                                    @elseif (request()->get('mvoie') == 1 && $particulier->voie = '00m')
