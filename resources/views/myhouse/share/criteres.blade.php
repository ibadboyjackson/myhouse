...
@isset($particulier->critere->last()->nombre_chambre)
    @if ( $particulier->critere->last()->nombre_chambre == 1 )
...
@isset($particulier->critere->last()->voie)
    @if ( $particulier->critere->last()->voie == 1 )

    <div class="page-list-panel-item-two-body-box-three-box">
        {{ __('myhouse/back/annonces/particulier/description.xet') }} {{ $particulier->voie }}
    </div>
...
@isset($particulier->critere->last()->riviere)
    ...
    <div class="page-list-panel-item-two-body-box-three-box">
        {{ __('myhouse/back/annonces/particulier/description.bbe') }} {{ $particulier->riviere }}
    </div>
...
@isset($particulier->critere->last()->golf)
    ...
    <div class="page-list-panel-item-two-body-box-three-box">
        {{ __('myhouse/back/annonces/particulier/description.aas') }} {{ $particulier->golf }} 
    </div>
...
@isset($particulier->critere->last()->foret)
    ...
    <div class="page-list-panel-item-two-body-box-three-box">
        {{ __('myhouse/back/annonces/particulier/description.aat') }} {{ $particulier->foret }}
    </div>
...
@isset($particulier->critere->last()->station_ski)
    ...
    <div class="page-list-panel-item-two-body-box-three-box">
        {{ __('myhouse/back/annonces/particulier/description.aau') }} {{ $particulier->station_ski }}
    </div>
...
@isset($particulier->critere->last()->reservation)
    ...
    <div class="page-list-panel-item-two-body-box-three-box">
        {{ str_replace('<br>', '', __('myhouse/back/annonces/particulier/description.abbl')) }}
    </div>
...
@isset($particulier->critere->last()->surface_disponible_un )
    @if ( $particulier->critere->last()->surface_disponible_un == 1)
...
@isset($particulier->critere->last()->surface_disponible_deux)
    @if ($particulier->critere->last()->surface_disponible_deux == 1 )
...
@isset($particulier->critere->last()->portail)
    ...
    <div class="page-list-panel-item-two-body-box-three-box">
       {{ __('myhouse/back/menu/particulier/annonce.aab') }} {{ __('myhouse/back/menu/particulier/annonce.aac') }}  {{ $particulier->portail }} m x {{ __('myhouse/back/menu/particulier/annonce.aad') }} {{ $particulier->portail_deux }} m
    </div>
@endif
@endisset
