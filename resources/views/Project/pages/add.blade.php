...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Ajouter un projet immobilier</div>
                    <div class="card-body">
                        <form action="{{ route('project.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nomProjet" class="form-control @error('nomProjet') is-invalid @enderror">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="dateAffiliation" class="form-control @error('dateAffiliation') is-invalid @enderror">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="budgetMin" class="form-control @error('budgetMin') is-invalid @enderror" placeholder="ex: 20000DH">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="budgetMax" class="form-control @error('budgetMax') is-invalid @enderror" placeholder="ex: 20000DH">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="addressePostale" class="form-control" placeholder="ex:10 bd Mohammed V">
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="superficieMinVilla" class="form-control @error('superficieMinVilla') is-invalid @enderror" placeholder="ex: 200 m²">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="superficieMaxVilla" class="form-control  @error('superficieMaxVilla') is-invalid @enderror" placeholder="ex: 400 m²">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="superficieMinTerrain" class="form-control @error('superficieMinTerrain') is-invalid @enderror" placeholder="ex: 200 m²">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="superficieMaxTerrain" class="form-control @error('superficieMaxTerrain') is-invalid @enderror" placeholder="ex: 400 m²">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="superficieMinAppartement">Superficie minimale appartement *</label>
                                        <input type="text" name="superficieMinAppartement" class="form-control  @error('superficieMinAppartement') is-invalid @enderror" placeholder="ex: 200 m²">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="superficieMaxAppartement">Superficie maximale appartement *</label>
                                        <input type="text" name="superficieMaxAppartement" class="form-control @error('superficieMaxAppartement') is-invalid @enderror" placeholder="ex: 400 m²">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="piscineCollectiveAppart" id="piscineCollectiveAppart" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="piscineCollectiveVilla" id="piscineCollectiveVilla" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="piscinePriveVilla" id="piscinePriveVilla" checked>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="garage" id="garage" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="garage2place" id="garage2place" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="climatisation" id="climatisation" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="parking" id="parking" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="parking2place" id="parking2place" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="golf" id="golf" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="centreCommercial" id="centreCommercial" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="hotel" id="hotel" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="hammam" id="hammam" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="terrainSport" id="terrainSport" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="restaurant" id="restaurant" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="salleFete" id="salleFete" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="accesForet" id="accesForet" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="surPlan" id="surPlan" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="salleConference" id="salleConference" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="accesPlage" id="accesPlage" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="jardin" id="jardin" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="gardiennage" id="gardiennage" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="conciergerie" id="conciergerie" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="blanchisserie" id="blanchisserie" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="shopping" id="shopping" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="theatre" id="theatre" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="ecole" id="ecole" checked>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="mosquee" id="mosquee" checked>
