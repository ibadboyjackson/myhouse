<template>
    ...
    <!-- HEADER -->
    <div class="wrap mt-73" id="fr">
        <header class="header">
            <form  method="get" id = "ghoumari-form">
                <input type="hidden" value="casablanca" name="location">
                <input type="hidden" value="mixte" name="page">
                <div class="temps">
                <span class="myHouse-circle">
                    ...
                    <div class="must-close">
                        <div class="d-flex justify-content-end mr-3 button-x mt-2">
                            <img src="/images/residential/x.svg" alt="" id="must-close">
                        </div>
                    </div>
                    <div class="temps-item">
                        <div class="grid_1">
                            <select class="selectpicker myHouse-select" name="transaction" v-model="transaction" @change="onChange()">
                                <option value="test" data-content="<img src='/images/residential/location.svg' class='myHouse-image-1'> &nbsp; &nbsp;&nbsp;&nbsp;     <span class='custom-txt-1'> LOCATION</span> "></option>
                                <option data-content="<img src='/images/residential/achat.svg' class='myHouse-image-1'>  &nbsp; &nbsp;&nbsp;&nbsp; <span class='custom-txt-1-1'>  ACHAT </span> "></option>
                                <option data-content="<img src='/images/residential/echange.svg' class='myHouse-image-1'>  &nbsp; &nbsp;&nbsp;&nbsp; <span class='custom-txt-1'>   ECHANGE </span> "></option>
                            </select>
                        </div>
                    </div>
                    <div class="temps-item">
                        <div class="grid_2">
                            <select class="selectpicker myHouse-select" title="Choisissez">
                                <option data-content="<img src='/images/residential/residential.svg' class='myHouse-image-2-1'> &nbsp; &nbsp;&nbsp;&nbsp; <span class='custom-txt-2-1'> RESIDENTIEL </span> "></option>
                                <option data-content="<img src='/images/residential/commercial.svg' class='myHouse-image-2-2'>  &nbsp; &nbsp;&nbsp;&nbsp; <span class='custom-txt-2-2'>  COMMERCIAL </span> "></option>
                                <option data-content="<img src='/images/residential/terrain.svg' class='myHouse-image-2-3'>  &nbsp; &nbsp;&nbsp;&nbsp; <span class='custom-txt-2-3'>   TERRAIN </span> "></option>
                            </select>
                        </div>
                    </div>
                    <div class="temps-item">
                            ...
                            <div class="p-sm-f">
                                ...
                                <div class="myHouse-three mt-27">
                                    <div class="myHouse-three-button">
                                        <div>
                                            <button id = "ghoumari-button-one" type="submit" class="ghoumari-button-one ghoumari-button-active"></button>
                                        </div>
                                        <div>
                                            <button id = "ghoumari-button-two"  type="submit" class="ghoumari-button-two "></button>
                                        </div>
                                        <div>
                                            <button id = "ghoumari-button-three" type="submit" class="ghoumari-button-three"></button>
                                        </div>
                                    </div>
                                </div>
                                <div class="legend">
                                ...
                                <span class="critere-around">
                                    <span class="critere-first d-inline-flex">
                                        <span class="critere-item c1">
                                            <span class="img-critere">
                                                <img src="/images/residential/room.svg" alt="">
                                            </span>
                                        ...
                                        <span class="critere-item c2">
                                            <span class="img-critere">
                                                <img src="/images/residential/furnished.svg" alt="">
                                            </span>
                                            <span class="critere-rest">
                                        ...
                                        <span class="critere-item c3">
                                            <span class="img-critere">
                                                <img src="/images/residential/bathroom.svg" alt="">
                                            </span>
                                            <span class="critere-rest">
                                                <span class="rest-slide">
                                    ...
                                    <span class="critere-second mt-5 d-flex justify-content-around mr-401">
                                        <span class="critere-item">
                                            <span class="img-critere">
                                                <img src="/images/residential/agenda.svg" alt="">
                                            </span>
                                            <span class="critere-rest">
                                        ...
                                        <span class="critere-item">
                                            <span class="img-critere">
                                                <img src="/images/residential/layer.svg" alt="">
                                            </span>
                                            <span class="critere-rest">
                                                <span class="rest-slide-2">
                                                    <input type="checkbox">
                                        ...
                                        <span class="critere-item">
                                            <span class="img-critere">
                                                <img src="/images/residential/friendship.svg" alt="">
                                            </span>
                                            <span class="critere-rest">
                                                <span class="rest-slide-2">
                                                    <input type="checkbox">
                                        ...
                                        <span class="critere-item">
                                            <span class="img-critere">
                                                <img src="/images/residential/student.svg" alt="">
                                            </span>
                                            <span class="critere-rest">
                                                <span class="rest-slide-2">
                                                    <input type="checkbox">
                    ...
                    <span class="myHouse-sort" id="myHouse-sort">
                                <span class="myHouse-sort-image">
                                    <img src="/images/residential/sort.svg" alt="">
                                </span>
                            <span class="myHouse-sort-text">Tri</span>
                            <span class="myHouse-sort-dropdown" id="myHouse-sort-dropdown" style="top: 76px">
...
export default {
    ...
    methods: {
        onChange () {
            console.log("The new values is :", this.transaction)
        }
    }
